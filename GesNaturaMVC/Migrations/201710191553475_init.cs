namespace GesNaturaMVC.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DuracaoAproximada = c.String(nullable: false),
                        Dificuldade = c.String(nullable: false),
                        GPS_Lat_Inicio = c.Single(nullable: false),
                        GPS_Long_Inicio = c.Single(nullable: false),
                        KmlPath = c.String(nullable: false),
                    })
                .PrimaryKey(t => t.ID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.POIs", "PercursoId", "dbo.Percursoes");
            ...
            DropIndex("dbo.POIs", new[] { "PercursoId" });
